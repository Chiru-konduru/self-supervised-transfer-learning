...
######### Extra Credit : Deep ResNet (ResNet152) ########
...
######### Extra Credit :retinanet  ########
def retinanet(pretrained=False, **kwargs):
    """Constructs a ResNet-152 model.
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
        pretrained_model = models.detection.retinanet_resnet50_fpn_v2(pretrained=True)
        model = update_state_dict(pretrained_model, model)
    return model

######### Extra Credit :fasterrcnn  ########
def fasterrcnn(pretrained=False, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
        pretrained_model = models.detection.fasterrcnn_resnet50_fpn_v2(pretrained=True)
        model = update_state_dict(pretrained_model, model)
    return model

######### Extra Credit :maskRcnn  ########
def maskRcnn(pretrained=False, **kwargs):
    """Constructs a ResNet-152 model.
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
        pretrained_model = models.detection.maskrcnn_resnet50_fpn_v2(pretrained=True)
        model = update_state_dict(pretrained_model, model)
    return model